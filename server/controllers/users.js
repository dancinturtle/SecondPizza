...
module.exports = (function(){
  return {
    create: function(req, res){
        ...
        //  var newuser = {name: req.body.name, password: req.body.lastname, username: req.body.username, email: req.body.email, password: req.body.password, salt: req.body.salt, phone: req.body.phone, home_lat: req.body.home_lat, home_long: req.body.home_long, image_path: req.body.image_path, visiting_lat: req.body.visiting_lat, visiting_long: req.body.visiting_long, created_at: new Date(), updated_at: new Date()};
